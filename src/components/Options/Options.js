...
class Options extends Component {
    ...
    frequencyChange(ev) {
        ...
        this.frequency = ev.target.value;
    }
    ...
    onSubmit() {
        ...
        if (!this.time || !this.frequency) {
            ...
            let frequency = this.frequency === "none" ? null : Number(this.frequency) * 60;
            const alarmInfo = {
                hours: Number(this.time.substring(0, this.time.indexOf(":"))),
                minutes: Number(this.time.substring(this.time.indexOf(":") + 1)),
                frequency
            };
            debugger;
        ...
        return (
            <div className="optionBox">
                    ...
                    ? (
                        <div className="currentAlarmInfo">
                            ...
                            <div className="currentFrequencyInfo">
                                Frequency
                                <div className="currentInfoContent">{this.props.alarmInfo.frequency}</div>
                            </div>
                        </div>
                    )
                    : (
                ...
                <div className="buttonBox">
                    <button className="submit" onClick={this.onSubmit}>set</button>
                    <button className="alarmOff" onClick={this.alarmOff}>
